...
import EditOrder from "./page/admin/edit-order";
    ...
    <div className="Cassava Super">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/panen/edit/:id" element={<EditOrder />} />
          ...
          <Route path="/profile-petani/edit/:id" element={<PetaniProfileEdit />} />
          ...
          <Route path="/profile-pabrik/edit/:id" element={<PabrikProfileEdit/>} />
          <Route path="/data-logistik" element={<LogistikList />} />
          <Route path="/data-logistik/add" element={<LogistikListAdd />} />
          <Route path="/data-logistik/edit/:id" element={<LogistikListEdit />} />
          <Route path="/profile-logistik" element={<LogistikProfile />} />
          <Route path="/profile-logistik/edit/:id" element={<LogistikProfileEdit />} />
        </Routes>
      </BrowserRouter>
    </div>
  );
